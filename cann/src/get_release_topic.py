...
# 读取 Excel 文件
file_path = '../data/CANN-20250530-release.xlsx'  # 请替换成您的文件路径
...
if __name__ == "__main__":
    get_topic_dict()
    origin_data = pd.read_excel('../data/merged_issue_forum_new2.xlsx', sheet_name="Sheet1")
    topics_summary = []
...
# # 将数据输出为 JSON 文件
# output_file = '../data/CANN-20250530-release.json'  # 输出的 JSON 文件路径
