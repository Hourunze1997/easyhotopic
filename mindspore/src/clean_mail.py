...
# 读取Excel文件
input_file = "../data/mindspore_email_data.xlsx"
df = pd.read_excel(input_file)

filters = [
    {"column": "title", "pattern": r'例会|公示|公告|纪要|非问题|公式关闭|升级通知|会议|转测试|订阅'},
...
# 保存为新的Excel文件
excel_filename = f"../data/filtered_mindspore_email_data.xlsx"
