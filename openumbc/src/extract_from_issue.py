...
if __name__ == "__main__":
    # 处理Excel文件
    process_excel(input_path="../data/openubmc_issue_open.xlsx", output_path="../data/processed_issues.xlsx")
    print("处理完成，结果已保存到 processed_issues.xlsx")
    # content = """
    # """
